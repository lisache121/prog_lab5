...
import ru.chernova.exceptions.EmptyFieldException;
import ru.chernova.exceptions.InvalidAgeInputException;
...
public class Dragon{
    ...
    public Dragon(@JsonProperty("id")Long id, @JsonProperty("name") String name, @JsonProperty("coordinates") Coordinates coordinates, @JsonProperty("creationDate") Date date, @JsonProperty("age") int age, @JsonProperty("description") String description, @JsonProperty("color") Color color, @JsonProperty("type") DragonType type, @JsonProperty("head") DragonHead head) {
        this.id = id;
        this.name = name;
